<template>
  <div class="demo-block demo-box demo-zh-CN demo-table">
    <div class="source" style="width: 50%;">
      <div class="el-table el-table--fit el-table--border el-table--enable-row-hover el-table--enable-row-transition"
        ...
        <div class="el-table__header-wrapper">
          <hzlb :columns="columns"></hzlb>
        </div>
        <div class="el-table__body-wrapper" style="height: 209px;">
          <hzlb :dataSource="dataSource" :columns="columns1" :rowClick="rowClick"></hzlb>
        </div>
        <div class="el-table__column-resize-proxy" style="display: none;"></div>
        <div class="resize-triggers">
          <div class="expand-trigger">
            <div style="width: 510px; height: 250px;"></div>
          </div>
...
<style>
  ...
  .clearfix[data-v-124aa674]:after, .clearfix[data-v-124aa674]:before {
    display: table;
    content: ""
  }

  .clearfix[data-v-124aa674]:after {
    clear: both
  }

  .share-button[data-v-124aa674] {
    width: 36px;
    padding: 10px
  }

  .mark[data-v-124aa674] {
    margin-top: 8px;
    line-height: 1;
    float: right
  }

  .item[data-v-124aa674] {
    margin-right: 40px
  }

  .clearfix[data-v-49977569]:after, .clearfix[data-v-49977569]:before {
    display: table;
    content: ""
  }

  .clearfix[data-v-49977569]:after {
    clear: both
  }

  .text[data-v-49977569] {
    font-size: 14px
  }

  .time[data-v-49977569] {
    font-size: 13px;
    color: #999
  }

  .bottom[data-v-49977569] {
    margin-top: 13px;
    line-height: 12px
  }

  .item[data-v-49977569] {
    padding: 18px 0
  }

  .button[data-v-49977569] {
    padding: 0;
    float: right
  }

  .image[data-v-49977569] {
    width: 100%;
    display: block
  }

  .box-card[data-v-49977569] {
    width: 480px
  }

  .demo-form.demo-en-US .el-select .el-input {
    width: 360px
  }

  .demo-form.demo-en-US .el-form {
    width: 480px
  }

  .demo-form.demo-en-US .line {
    text-align: center
  }

  .demo-form.demo-en-US .el-checkbox-group {
    width: 320px;
    margin: 0;
    padding: 0;
    list-style: none
  ...
  .demo-form.demo-en-US .el-checkbox-group .el-checkbox {
    float: left;
    width: 160px;
    padding-right: 20px;
    margin: 0;
  ...
  .demo-form.demo-en-US .el-checkbox-group .el-checkbox + .el-checkbox {
    margin-left: 0
  }

  .demo-form.demo-en-US .el-checkbox-group:after, .demo-form.demo-en-US .el-checkbox-group:before {
    content: " ";
    display: table
  }

  .demo-form.demo-en-US .el-checkbox-group:after {
    clear: both;
    visibility: hidden;
    font-size: 0;
    height: 0
  ...
  .demo-form.demo-en-US .demo-form-normal {
    width: 480px
  }

  .demo-form.demo-en-US .demo-form-inline .el-input {
    width: 150px
  }

  .demo-form.demo-en-US .demo-form-inline > * {
    margin-right: 10px
  }

  .demo-form.demo-en-US .demo-ruleForm {
    width: 480px
  }

  .demo-form.demo-en-US .demo-ruleForm .el-select .el-input {
    width: 360px
  }

  .demo-form.demo-en-US .demo-dynamic .el-input {
    margin-right: 10px;
    width: 270px;
    vertical-align: top
  }

  .demo-form.demo-en-US .fr {
    float: right
  }

  .demo-input.demo-en-US .el-select .el-input {
    width: 110px
  }

  .demo-input.demo-en-US .el-input {
    width: 180px
  }

  .demo-input.demo-en-US .el-textarea {
    width: 414px
  }

  .demo-input.demo-en-US .el-input-group {
    width: 100%
  }

  .demo-input.demo-en-US .demo-input-size .el-input {
    vertical-align: top;
    margin: 0 10px 10px 0
  }

  .demo-input.demo-en-US .demo-autocomplete {
    text-align: center
  }

  .demo-input.demo-en-US .demo-autocomplete .sub-title {
    margin-bottom: 10px;
    font-size: 14px;
    color: #8492a6
  }

  .demo-input.demo-en-US .demo-autocomplete .el-col:not(:last-child) {
    border-right: 1px solid rgba(224, 230, 237, .5)
  }

  .demo-input.demo-en-US .demo-autocomplete .el-autocomplete {
    text-align: left
  }

  .el-autocomplete__suggestions.my-autocomplete li {
    line-height: normal;
    padding-top: 7px;
    padding-bottom: 7px
  }

  .el-autocomplete__suggestions.my-autocomplete li .name {
    text-overflow: ellipsis;
    overflow: hidden
  }

  .el-autocomplete__suggestions.my-autocomplete li .addr {
    font-size: 12px;
    color: #b4b4b4
  }

  .el-autocomplete__suggestions.my-autocomplete li .highlighted .addr {
    color: #ddd
  }
  ...
  .demo-box.demo-tag .input-new-tag .el-input__inner {
    height: 24px
  }

  .demo-tooltip.demo-en-US .box .left {
    float: left;
    width: 110px
  }

  .demo-tooltip.demo-en-US .box .right {
    float: right;
    width: 110px
  }

  .demo-tooltip.demo-en-US:first-of-type .source .el-button {
    width: 110px
  }
  ...
  .clearfix[data-v-2f7a87c2]:after, .clearfix[data-v-2f7a87c2]:before {
    display: table;
    content: ""
  }

  .clearfix[data-v-2f7a87c2]:after {
    clear: both
  }

  .share-button[data-v-2f7a87c2] {
    width: 36px;
    padding: 10px
  }

  .mark[data-v-2f7a87c2] {
    margin-top: 8px;
    line-height: 1;
    float: right
  }

  .item[data-v-2f7a87c2] {
    margin-right: 40px
  }
  ...
  .clearfix[data-v-29f0ea94]:after, .clearfix[data-v-29f0ea94]:before {
    display: table;
    content: ""
  }

  .clearfix[data-v-29f0ea94]:after {
    clear: both
  }

  .text[data-v-29f0ea94] {
    font-size: 14px
  }

  .time[data-v-29f0ea94] {
    font-size: 13px;
    color: #999
  }

  .bottom[data-v-29f0ea94] {
    margin-top: 13px;
    line-height: 12px
  }

  .item[data-v-29f0ea94] {
    padding: 18px 0
  }

  .button[data-v-29f0ea94] {
    padding: 0;
    float: right
  }

  .image[data-v-29f0ea94] {
    width: 100%;
    display: block
  }

  .box-card[data-v-29f0ea94] {
    width: 480px
  }
  ...
  .demo-box.demo-dialog .el-input, .demo-box.demo-dialog .el-select {
    width: 300px
  }
  ...
  .cards[data-v-5796b62b] {
    margin: 30px 0 70px
  }

  .card[data-v-5796b62b] {
    background: #fbfcfd;
    height: 204px;
    text-align: center
  }

  .card img[data-v-5796b62b] {
    margin: 40px auto 25px;
    width: 80px;
    height: 80px
  }

  .card h4[data-v-5796b62b] {
    font-size: 18px;
    color: #1f2d3d;
    font-weight: 400;
    margin: 0
  ...
  .card span[data-v-5796b62b] {
    font-size: 14px;
    color: #99a9bf
  }

  .cards[data-v-5c8a87fa] {
    margin: 30px 0 70px
  }

  .card[data-v-5c8a87fa] {
    background: #fbfcfd;
    height: 204px;
    text-align: center
  }

  .card img[data-v-5c8a87fa] {
    margin: 40px auto 25px;
    width: 80px;
    height: 80px
  }

  .card h4[data-v-5c8a87fa] {
    font-size: 18px;
    color: #1f2d3d;
    font-weight: 400;
    margin: 0
  ...
  .nav-demos p[data-v-58b47986] {
    margin-bottom: 50px
  }

  .nav-demos h5[data-v-58b47986] {
    margin: 0
  }

  .nav-demos img[data-v-58b47986] {
    padding: 15px;
    background-color: #f9fafc;
    width: 100%;
    margin-bottom: 15px;
  ...
  .dialog-img .imgWrap[data-v-58b47986] {
    margin: 0 auto;
    position: relative;
    top: 100px;
    padding-bottom: 50px
  ...
  .dialog-img img[data-v-58b47986] {
    display: block;
    width: 100%
  }

  .mask[data-v-58b47986] {
    position: fixed;
    top: 0;
    right: 0;
    left: 0;
  ...
  .zoom-enter-active[data-v-58b47986], .zoom-leave-active[data-v-58b47986] {
    transition: transform .3s cubic-bezier(.78, .14, .15, .86), opacity .3s cubic-bezier(.78, .14, .15, .86)
  }

  .zoom-enter[data-v-58b47986], .zoom-leave-active[data-v-58b47986] {
    transform: scale(.3);
    opacity: 0
  }

  .fade-enter-active[data-v-58b47986], .fade-leave-active[data-v-58b47986] {
    transition: opacity .3s cubic-bezier(.78, .14, .15, .86)
  }

  .fade-enter[data-v-58b47986], .fade-leave-active[data-v-58b47986] {
    opacity: 0
  }
  ...
  .nav-demos p[data-v-ae6bfaa4] {
    margin-bottom: 50px
  }

  .nav-demos h5[data-v-ae6bfaa4] {
    margin: 0
  }

  .nav-demos img[data-v-ae6bfaa4] {
    padding: 15px;
    background-color: #f9fafc;
    width: 100%;
    margin-bottom: 15px;
  ...
  .dialog-img .imgWrap[data-v-ae6bfaa4] {
    margin: 0 auto;
    position: relative;
    top: 100px;
    padding-bottom: 50px
  ...
  .dialog-img img[data-v-ae6bfaa4] {
    display: block;
    width: 100%
  }

  .mask[data-v-ae6bfaa4] {
    position: fixed;
    top: 0;
    right: 0;
    left: 0;
  ...
  .zoom-enter-active[data-v-ae6bfaa4], .zoom-leave-active[data-v-ae6bfaa4] {
    transition: transform .3s cubic-bezier(.78, .14, .15, .86), opacity .3s cubic-bezier(.78, .14, .15, .86)
  }

  .zoom-enter[data-v-ae6bfaa4], .zoom-leave-active[data-v-ae6bfaa4] {
    transform: scale(.3);
    opacity: 0
  }

  .fade-enter-active[data-v-ae6bfaa4], .fade-leave-active[data-v-ae6bfaa4] {
    transition: opacity .3s cubic-bezier(.78, .14, .15, .86)
  }

  .fade-enter[data-v-ae6bfaa4], .fade-leave-active[data-v-ae6bfaa4] {
    opacity: 0
  }

  .cards .container[data-v-e543a18a]:after, .cards .container[data-v-e543a18a]:before {
    display: table;
    content: ""
  }

  .cards .container[data-v-e543a18a]:after {
    clear: both
  }

  .page-resource[data-v-e543a18a] {
    padding-top: 55px;
    box-sizing: border-box
  }

  .cards[data-v-e543a18a] {
    margin: 35px auto 110px
  }

  .cards .container[data-v-e543a18a] {
    padding: 0;
    margin: 0 -11px;
    width: auto
  }

  .cards li[data-v-e543a18a] {
    width: 33.33333%;
    padding: 0 11px;
    box-sizing: border-box;
    float: left;
  ...
  .card img[data-v-e543a18a] {
    margin: 75px auto 35px;
    height: 87px
  }

  .card h3[data-v-e543a18a] {
    margin: 0 0 10px;
    font-size: 18px;
    color: #1f2f3d;
    font-weight: 400;
  ...
  @media (max-width: 850px) {
    ...
    .cards li .card[data-v-e543a18a] {
      height: auto;
      padding-bottom: 20px
    }

    .cards h3[data-v-e543a18a] {
      height: auto
    }
  }

  .cards .container[data-v-0e981f13]:after, .cards .container[data-v-0e981f13]:before {
    display: table;
    content: ""
  }

  .cards .container[data-v-0e981f13]:after {
    clear: both
  }

  .page-resource[data-v-0e981f13] {
    padding-top: 55px;
    box-sizing: border-box
  }

  .cards[data-v-0e981f13] {
    margin: 35px auto 110px
  }

  .cards .container[data-v-0e981f13] {
    padding: 0;
    margin: 0 -11px;
    width: auto
  }

  .cards li[data-v-0e981f13] {
    width: 33.33333%;
    padding: 0 11px;
    box-sizing: border-box;
    float: left;
  ...
  .card img[data-v-0e981f13] {
    margin: 75px auto 35px;
    height: 87px
  }

  .card h3[data-v-0e981f13] {
    margin: 0 0 10px;
    font-size: 18px;
    color: #1f2f3d;
    font-weight: 400;
  ...
  @media (max-width: 850px) {
    ...
    .cards li .card[data-v-0e981f13] {
      height: auto;
      padding-bottom: 20px
    }

    .cards h3[data-v-0e981f13] {
      height: auto
    }
  }

  .cards .container[data-v-043be2f5]:after, .cards .container[data-v-043be2f5]:before {
    display: table;
    content: ""
  }

  .cards .container[data-v-043be2f5]:after {
    clear: both
  }

  .actor[data-v-043be2f5] {
    min-height: 65px
  }

  .actor[data-v-043be2f5]:after {
    content: "";
    width: 6px;
    height: 50px;
    vertical-align: -8px;
  ...
  .banner .container[data-v-043be2f5] {
    position: relative
  }

  .banner img[data-v-043be2f5] {
    position: absolute;
    top: 15px;
    right: -10px
  }

  .banner-sky[data-v-043be2f5] {
    position: absolute;
    top: -150px;
    bottom: -15px;
    width: 100%;
  ...
  img.banner-stars[data-v-043be2f5] {
    top: -10px;
    left: 50%;
    transform: translateX(-50%)
  }

  .banner-desc[data-v-043be2f5] {
    padding-top: 110px;
    padding-left: 30px;
    font-size: 42px;
    position: relative;
  ...
  .banner-desc h2[data-v-043be2f5] {
    font-size: 50px;
    margin: 0;
    color: #fff
  }

  .banner-desc p[data-v-043be2f5] {
    font-size: 14px;
    opacity: .8;
    width: 420px;
    line-height: 1.6;
  ...
  .cards[data-v-043be2f5] {
    margin: 0 auto 110px;
    width: 1140px
  }

  .cards .container[data-v-043be2f5] {
    padding: 0;
    margin: 0 -11px;
    width: auto
  }

  .cards li[data-v-043be2f5] {
    width: 33.33333%;
    padding: 0 19px;
    box-sizing: border-box;
    float: left;
  ...
  .cards img[data-v-043be2f5] {
    width: 160px;
    height: 120px
  }

  .card[data-v-043be2f5] {
    height: 430px;
    width: 100%;
    background: #fff;
    border: 1px solid #eaeefb;
  ...
  .card img[data-v-043be2f5] {
    margin: 66px auto 60px
  }

  .card h3[data-v-043be2f5] {
    margin: 0;
    font-size: 18px;
    color: #1f2f3d;
    font-weight: 400
  ...
  .card a[data-v-043be2f5]:hover {
    color: #fff;
    background: #20a0ff
  }

  .card[data-v-043be2f5]:hover {
    bottom: 6px;
  ...
  @media (max-width: 1140px) {
    .cards .container[data-v-043be2f5], .cards[data-v-043be2f5] {
      width: 100%
    }
  ...
  @media (max-width: 1000px) {
    .banner .container img[data-v-043be2f5] {
      display: none
    }
  }
  ...
  @media (max-width: 768px) {
    ...
    .cards .card[data-v-043be2f5] {
      height: auto;
      padding-bottom: 54px
    }

    .banner-desc #line2[data-v-043be2f5], .banner-stars[data-v-043be2f5] {
      display: none
    }
  ...
  .cards .container[data-v-b5d87bc6]:after, .cards .container[data-v-b5d87bc6]:before {
    display: table;
    content: ""
  }

  .cards .container[data-v-b5d87bc6]:after {
    clear: both
  }

  .actor[data-v-b5d87bc6] {
    min-height: 65px
  }

  .actor[data-v-b5d87bc6]:after {
    content: "";
    width: 6px;
    height: 50px;
    vertical-align: -8px;
  ...
  .banner .container[data-v-b5d87bc6] {
    position: relative
  }

  .banner img[data-v-b5d87bc6] {
    position: absolute;
    top: 15px;
    right: -10px
  }

  .banner-sky[data-v-b5d87bc6] {
    position: absolute;
    top: -150px;
    bottom: -15px;
    width: 100%;
  ...
  img.banner-stars[data-v-b5d87bc6] {
    top: -10px;
    left: 50%;
    transform: translateX(-50%)
  }

  .banner-desc[data-v-b5d87bc6] {
    padding-top: 110px;
    padding-left: 30px;
    font-size: 46px;
    position: relative;
  ...
  .banner-desc h2[data-v-b5d87bc6] {
    font-size: 46px;
    margin: 0;
    color: #fff
  }

  .banner-desc p[data-v-b5d87bc6] {
    font-size: 14px;
    opacity: .8;
    width: 420px;
    line-height: 1.8;
  ...
  .cards[data-v-b5d87bc6] {
    margin: 0 auto 110px;
    width: 1140px
  }

  .cards .container[data-v-b5d87bc6] {
    padding: 0;
    margin: 0 -11px;
    width: auto
  }

  .cards li[data-v-b5d87bc6] {
    width: 33.33333%;
    padding: 0 19px;
    box-sizing: border-box;
    float: left;
  ...
  .cards img[data-v-b5d87bc6] {
    width: 160px;
    height: 120px
  }

  .card[data-v-b5d87bc6] {
    height: 430px;
    width: 100%;
    background: #fff;
    border: 1px solid #eaeefb;
  ...
  .card img[data-v-b5d87bc6] {
    margin: 66px auto 60px
  }

  .card h3[data-v-b5d87bc6] {
    margin: 0;
    font-size: 18px;
    color: #1f2f3d;
    font-weight: 400
  ...
  .card a[data-v-b5d87bc6]:hover {
    color: #fff;
    background: #20a0ff
  }

  .card[data-v-b5d87bc6]:hover {
    bottom: 6px;
    box-shadow: 0 6px 18px 0 rgba(232, 237, 250, .5)
  }
  ...
  @media (max-width: 1140px) {
    .cards .container[data-v-b5d87bc6], .cards[data-v-b5d87bc6] {
      width: 100%
    }
  ...
  @media (max-width: 1000px) {
    .banner .container img[data-v-b5d87bc6] {
      display: none
    }
  }
  ...
  @media (max-width: 768px) {
    ...
    .cards .card[data-v-b5d87bc6] {
      height: auto;
      padding-bottom: 54px
    }

    .banner-desc #line2[data-v-b5d87bc6], .banner-stars[data-v-b5d87bc6] {
      display: none
    }
  ...
  .el-table .el-tooltip, .el-table .el-tooltip__rel {
    display: block
  }
  ...
  .header .nav[data-v-7955f3a1]:after, .header .nav[data-v-7955f3a1]:before {
    display: table;
    content: ""
  }

  .header .nav[data-v-7955f3a1]:after {
    clear: both
  }

  .headerWrapper[data-v-7955f3a1] {
    height: 80px
  }

  .header[data-v-7955f3a1] {
    height: 80px;
    background-color: #20a0ff;
    color: #fff;
    top: 0;
  ...
  .header .container[data-v-7955f3a1] {
    height: 100%;
    box-sizing: border-box
  }

  .header h1[data-v-7955f3a1] {
    margin: 0;
    float: left;
    font-size: 32px;
    font-weight: 400
  ...
  .header h1 a[data-v-7955f3a1] {
    color: #fff;
    text-decoration: none;
    display: block
  }

  .header h1 span[data-v-7955f3a1] {
    font-size: 12px;
    display: inline-block;
    width: 34px;
    height: 18px;
  ...
  .header .nav-logo-small[data-v-7955f3a1], .header .nav-logo[data-v-7955f3a1] {
    vertical-align: sub
  }

  .header .nav-logo-small[data-v-7955f3a1] {
    display: none
  }

  .header .nav-item[data-v-7955f3a1] {
    margin: 0;
    float: left;
    list-style: none;
    position: relative;
  ...
  .header .nav-item a[data-v-7955f3a1] {
    text-decoration: none;
    color: #fff;
    display: block;
    padding: 0 20px;
  ...
  .header .nav-item a.active[data-v-7955f3a1], .header .nav-item a[data-v-7955f3a1]:hover {
    opacity: 1
  }

  .header .nav-item a.active[data-v-7955f3a1] {
    font-weight: 700
  }

  .header .nav-item a.active[data-v-7955f3a1]:before {
    content: "";
    display: block;
    position: absolute;
    bottom: 0;
  ...
  .header .nav-item[data-v-7955f3a1]:last-child {
    cursor: default;
    margin-left: 34px
  }

  .header .nav-item:last-child span[data-v-7955f3a1] {
    opacity: .8
  }

  .header .nav-item:last-child .nav-lang[data-v-7955f3a1] {
    cursor: pointer;
    display: inline-block;
    height: 100%
  }

  .header .nav-item:last-child .nav-lang[data-v-7955f3a1]:hover {
    opacity: 1
  }

  .header .nav-item:last-child .nav-lang.active[data-v-7955f3a1] {
    font-weight: 700;
    opacity: 1
  }

  .header-home[data-v-7955f3a1] {
    position: fixed;
    top: 0;
  ...
  @media (max-width: 850px) {
    .header .nav-logo[data-v-7955f3a1] {
      display: none
    }
  ...
  @media (max-width: 700px) {
    ...
    .header .nav-item a[data-v-7955f3a1], .header .nav-lang[data-v-7955f3a1] {
      font-size: 12px;
      vertical-align: top
    }
  }
  ...
  @font-face {font-family: "elementdoc";
    src: url('//at.alicdn.com/t/font_1473762766_5418587.eot'); /* IE9*/
    src: url('//at.alicdn.com/t/font_1473762766_5418587.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
    url('data:application/x-font-woff;charset=utf-8;base64,') format('woff'), /* chrome,firefox */
    url('//at.alicdn.com/t/font_1473762766_5418587.ttf') format('truetype'), /* chrome,firefox,opera,Safari, Android, iOS 4.2+*/
    url('//at.alicdn.com/t/font_1473762766_5418587.svg#elementdoc') format('svg'); /* iOS 4.1- */
    src: url('//at.alicdn.com/t/font_1473762766_5418587.eot')\0; /* ie8 fix */
